--[[
    Created by lixy at 2019-02-25 21:19
    @brief: 
        MySql数据库操作管理
]]
--[[
    @author: Created by lixy at 2019-02-25 21:22
    @brief:	 
...
--[[
	...
	错误：1004 SQLSTATE: HY000 (ER_CANT_CREATE_FILE) 消息：无法创建文件'%s' (errcode: %d)
	错误：1005 SQLSTATE: HY000 (ER_CANT_CREATE_TABLE)    消息：无法创建表'%s' (errcode: %d)
	错误：1006 SQLSTATE: HY000 (ER_CANT_CREATE_DB)   消息：无法创建数据库'%s' (errcode: %d)
	...
	错误：1009 SQLSTATE: HY000 (ER_DB_DROP_DELETE)   消息：撤销数据库时出错（无法删除'%s'，errcode: %d）
	错误：1010 SQLSTATE: HY000 (ER_DB_DROP_RMDIR)    消息：撤销数据库时出错（can't rmdir '%s', errcode: %d）
	错误：1011 SQLSTATE: HY000 (ER_CANT_DELETE_FILE) 消息：删除'%s'时出错 (errcode: %d)
	错误：1012 SQLSTATE: HY000 (ER_CANT_FIND_SYSTEM_REC) 消息：无法读取系统表中的记录。
	错误：1013 SQLSTATE: HY000 (ER_CANT_GET_STAT)    消息：无法获取'%s'的状态(errcode: %d)
	错误：1014 SQLSTATE: HY000 (ER_CANT_GET_WD)      消息：无法获得工作目录(errcode: %d)
	错误：1015 SQLSTATE: HY000 (ER_CANT_LOCK)        消息：无法锁定文件(errcode: %d)
	错误：1016 SQLSTATE: HY000 (ER_CANT_OPEN_FILE)   消息：无法打开文件：'%s' (errcode: %d)
	错误：1017 SQLSTATE: HY000 (ER_FILE_NOT_FOUND)   消息：无法找到文件： '%s' (errcode: %d)
	错误：1018 SQLSTATE: HY000 (ER_CANT_READ_DIR)    消息：无法读取'%s'的目录 (errcode: %d)
	错误：1019 SQLSTATE: HY000 (ER_CANT_SET_WD)      消息：无法为'%s'更改目录 (errcode: %d)
	...
	错误：1023 SQLSTATE: HY000 (ER_ERROR_ON_CLOSE)   消息：关闭'%s'时出错 (errcode: %d)
	错误：1024 SQLSTATE: HY000 (ER_ERROR_ON_READ)    消息：读取文件'%s'时出错 (errcode: %d)
	错误：1025 SQLSTATE: HY000 (ER_ERROR_ON_RENAME)  消息：将'%s'重命名为'%s'时出错 (errcode: %d)
	错误：1026 SQLSTATE: HY000 (ER_ERROR_ON_WRITE)   消息：写入文件'%s'时出错 (errcode: %d)
	...
	错误：1030 SQLSTATE: HY000 (ER_GET_errcode)    消息：从存储引擎中获得错误%d。
	...
	错误：1039 SQLSTATE: HY000 (ER_UNEXPECTED_EOF)   消息：读取文件'%s'时出现意外EOF (errcode: %d)
	...
	错误：1126 SQLSTATE: HY000 (ER_CANT_OPEN_LIBRARY)		消息：不能打开共享库'%s' (errcode: %d %s)
	...
	错误：1135 SQLSTATE: HY000 (ER_CANT_CREATE_THREAD)		消息：无法创建新线程(errcode %d)，如果未出现内存溢出，请参阅手册以了解可能的与操作系统有关的缺陷。
	...
	错误：1388 SQLSTATE: HY000 (ER_NO_FILE_MAPPING)		消息：无法映射文件: %s, errcode: %d
...
由于更新很频繁，这些文件中可能包含这里未列出的额外错误消息。
	...
	错误：2041 (CR_SHARED_MEMORY_CONNECT_MAP_ERROR)  消息：不能打开共享内存，服务器不能获得文件映射的指针(%lu)
	错误：2042 (CR_SHARED_MEMORY_FILE_MAP_ERROR) 消息：不能打开共享内存，客户端不能分配文件映射(%lu)
	错误：2043 (CR_SHARED_MEMORY_MAP_ERROR)      消息：不能打开共享内存，客户端不能获得文件映射的指针(%lu)
	错误：2044 (CR_SHARED_MEMORY_EVENT_ERROR)    消息：不能打开共享内存，客户端不能创建%s事件(%lu)
	错误：2045 (CR_SHARED_MEMORY_CONNECT_ABANDONED_ERROR)    消息：不能打开共享内存，无来自服务器的应答 (%lu)
	错误：2046 (CR_SHARED_MEMORY_CONNECT_SET_ERROR)      消息：不能打开共享内存，不能将请求事件发送到服务器(%lu)
	错误：2047 (CR_CONN_UNKNOW_PROTOCOL)     消息：错误或未知协议
	错误：2048 (CR_INVALID_CONN_HANDLE)      消息：无效的连接句柄
	错误：2049 (CR_SECURE_AUTH)      消息：拒绝使用旧鉴定协议（早于4.1.1）的连接（开启了客户端'secure_auth'选项）。
	错误：2050 (CR_FETCH_CANCELED)   消息：行检索被mysql_stmt_close()调用取消。
	错误：2051 (CR_NO_DATA)      消息：在未事先获取行的情况下试图读取列。
	错误：2052 (CR_NO_STMT_METADATA)     消息：预处理语句不含元数据。
	错误：2053 (CR_NO_RESULT_SET)        消息：在没有与语句相关的结果集时试图读取行。
	错误：2054 (CR_NOT_IMPLEMENTED)  消息：该特性尚未实施。
]]
...
local  MYSQL_CONNECT_TIME_OUT = 3000    -- 超时时间
local  MYSQL_CONNECT_KEEPALIVE_TIME = 10000	-- 缓冲池保存时间
local  MYSQL_CONNECT_POOL_SIZE = 1000    -- 增强缓冲池的能力 可以将该值设置为5000


local _M = {
	_db = nil, 	-- 数据库操作对象
	_transaction = false, -- 事务状态, true：事务开启
	m_is_err = false
}


--[[
	Created by lixy at 2019-02-28 20:32
	@brief:	 初始化数据库管理对象
	@param:	 
		conf: 	[object] 数据库信息，格式如下： 
				{
					host = "139.196.180.249",
					port = 3306,
					database = "xxx",
					user = "admin",
					password = "zhengsu@xxxx",
					max_packet_size = 1024 * 1024
				}
		t_timeout：	[int] 超时时长，单位毫秒，默认5000
	@return:	
		数据库管理对象 
]]
function _M:new(conf, t_timeout)
    ...
    if not db then
        ngx.log(ngx.ERR, "系统错误, resty.mysql:new()失败，error=", err)
        return nil, "初始化resty.mysql失败"
    end
    db:set_timeout(t_timeout or MYSQL_CONNECT_TIME_OUT)
    local res, err, errcode, sqlstate = db:connect(conf)
    if not res then
        ngx.log(ngx.ERR, "MySql数据库连接错误，error=",err,", errcode=",errcode)
        return nil, "MySql数据库连接错误"
    end

    local res, err, errcode, sqlstate = db:query("SET NAMES UTF8;")
    if not res then
        ngx.log(ngx.ERR, "MySql数据库执行语句错误, error=", err, ", sql=SET NAMES UTF8;")
...
--[[
	Created by lixy at 2019-02-28 20:48
	@brief:	 执行SQL语句
	@param:	 
		sql: [string] 完整sql语句
	@return:	 
		$1:	[object] 执行结果， nil表示执行错误
		$2: [int] 错误信息
		$3: [int] 错误码
		$4: [int] sql状态码
]]
function _M:query(sql)
    ...
    local res, err, errcode, sqlstate =  self._db:query(sql)
	if not res then
		ngx.log(ngx.ERR, string.format("MySql数据库错误，error=%s", err, ", sql=", sql))
		self.m_is_err = true
	end
...
--[[
	Created by lixy at 2019-02-28 20:50
	@brief:	 开启事务 
	@param:	 无
	@return:	 
		$1:	[object] 执行结果， nil表示执行错误
...
function _M:start_transaction()
	...
	local res, err, errcode, sqlstate = self:query("START TRANSACTION;")
	if res then
...
--[[
	Created by lixy at 2019-02-28 20:56
	@brief:	 提交事务 
	@param:	 无
	@return:	 
		$1:	[object] 执行结果， nil表示执行错误
...
function _M:commit()
	local res, err, errcode, sqlstate = self:query("COMMIT;")
	if res then
...
--[[
	Created by lixy at 2019-02-28 20:57
	@brief:	回滚事务
	@param:	无
	@return:	 
		$1:	[object] 执行结果， nil表示执行错误
...
function _M:rollback()
	local res, err, errcode, sqlstate = self:query("ROLLBACK;")
	if res then
		self._transaction = false
	end
	return res, err, errcode, sqlstate
...
--[[
	Created by lixy at 2019-02-28 21:00
	@brief:	 保存连接到连接池
	@param:	 无
	@return:	 
]]
function _M:keepalive(t_alive, pool_size)
	if not self._db then
		return nil, "数据库没有初始化"
	end
    return self._db:set_keepalive(t_alive or MYSQL_CONNECT_KEEPALIVE_TIME, pool_size or MYSQL_CONNECT_POOL_SIZE)
end


--[[
	Created by lixy at 2019-02-28 21:02
	@brief:	 
	@param:	 
	@return:	 
]]
function _M.muti_query(sql, nums)
    local res, err, errcode, sqlstate = self:query(sql, nums)
    if not res then
        return res, err, errcode, sqlstate
    end
    local result = {}
    ...
    local index = 1
    while err == "again" do
        local  res, err, errcode, sqlstate = self._db:read_result()
        if not res then
            break;
        else
            index = index + 1
...
--[[
	Created by lixy at 2018-12-18 10:48
	@brief:	 拼接sql语句
	@param:
		str: 已经生成的语句，当前生成的新字符串会拼接到该语句后
		key: 参数名称
		val: 参数值
		symbol: 单个条件参数的比较操作符 例如 =, !=
		prefix: 多个条件的sql连接操作符 例如 and, or
	@return:
		拼接后的语句
	@example:
		local s = ""
		s = _M.append_sql(s, "name", "helloworld", "=", and) -- 拼接后 s ==> name='helloworld'
		s = _M.append_sql(s, "age", "18", "=", "and") -- 拼接后 s ==> name='helloworld' and age='18'
	
]]
function _M.append_sql(str, key, val, symbol, prefix)
	if not key or not val then
		return str or ""
	end
	local buf = string.format("%s%s'%s'", key, symbol, val)
	if str and str~="" then
		if prefix then
			buf = prefix .. " " .. buf
		end
...
--[[
	Created by lixy at 2019-03-01 08:56
	@brief:	 格式化 INSERT SQL 语句
	@param:	 
		tb_name: [string] 表名
		params:  [object] 参数列表 (字段名=值) 例： { id = "1001" } 
	@return:
		$1: [string] SQL 语句
]]
function _M.fmt_insert(tb_name, params)
	-- INSERT INTO t_0 (k1,k2,k3) VALUES ('v1','v2','v3')
	local keys = ""
	local values = ""
	...
	local sql = string.format("INSERT INTO %s (%s) VALUES (%s)", tb_name, keys, values)
	return sql
end

--[[
	Created by lixy at 2019-03-01 08:57
	@brief:	 格式化 UPDATE SQL 语句
	@param:	 
	@return:	
]]
function _M.fmt_update(tb_name, params, sql_where)
	-- UPDATE t_0 SET name='A' WHERE id='0'
	local sql = ""
	for k, v in pairs(params) do
		if sql ~= '' then
			sql = sql .. ","
		end
		sql = sql .. string.format("%s='%s'", k, v)
	end
	return string.format("UPDATE %s SET %s WHERE %s", tb_name, sql, sql_where)
end


--[[
	Created by lixy at 2019-03-01 08:58
	@brief:	 格式化 DELETE SQL 语句
	@param:	 
	@return:	
]]
function _M.fmt_delete(tb_name, sql_where)
	-- DELETE FROM t_0 WHERE id='0'
	return strinf.format("DELETE FROM %s WHERE %s", tb_name, sql_where)
end

--[[
	Created by lixy at 2018-12-25 10:38
	@brief: 分页查询, 并将数据结果分页格式处理	
	@param:
		tb_name: 	[string] 表名称
		condition: 	[string] 查询条件, 例如: WHERE id='100'
		page: 		[int] 当前页码
...
function _M:paging(tb_name, condition, page, page_size)
	local page = tonumber(page or 1)
    local page_size = tonumber(page_size or 100)
    if not page or page < 1 then
        page = 1
    end
    if not page_size or page_size < 1 then
        page_size = 100
	end

	local sql = string.format("SELECT count(1) count FROM %s %s", tb_name, condition) 
