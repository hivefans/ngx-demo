...
--  作者:Steven
--  日期:2017-02-26
--  文件名:lua/resty/utils/thread/ngx_thread_help.lua
...
local mutex_help = require "resty.utils.thread.mutex_help"
...
function _M:thread_start( _time_out)
	...
	if not self.proc_cb then
		ngx.log(ngx.ERR, "proc_cb is nil!")
		return false
	end
